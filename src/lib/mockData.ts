...
export const mockPlans: Plan[] = [
  { id: 'plan_basic', name: 'basic', label: 'Basic', price_monthly: 49, price_annual: 470, billing_cycle: 'monthly', max_students: 200, max_buses: 5, max_drivers: 10, features: ['GPS Tracking', 'QR Attendance', 'Push Notifications', 'Basic Reports', 'Email Support'] },
  { id: 'plan_standard', name: 'standard', label: 'Standard', price_monthly: 99, price_annual: 950, billing_cycle: 'monthly', max_students: 500, max_buses: 15, max_drivers: 25, is_popular: true, features: ['Everything in Basic', 'WhatsApp Alerts', 'Leave Management', 'Lost & Found', 'Bus Transfer', 'Training Centre', 'Priority Support'] },
  { id: 'plan_premium', name: 'premium', label: 'Premium', price_monthly: 199, price_annual: 1910, billing_cycle: 'monthly', max_students: 99999, max_buses: 99999, max_drivers: 99999, features: ['Everything in Standard', 'Unlimited All', 'Guest Driver Module', 'SMS Notifications', 'Full Analytics', 'Audit Logs', 'API Access', 'Dedicated Support'] },
]

// ─── Schools ──────────────────────────────────────────────────────────────────
export const mockSchools: School[] = [
  { id: 'sch_001', name: 'Al-Noor International School', address: '45 Sheikh Zayed Road', city: 'Dubai', state: 'Dubai', phone: '+971-4-555-0100', email: 'admin@alnoor.ae', plan_id: 'plan_premium', plan_name: 'Premium', status: 'active', subdomain: 'alnoor', student_count: 1240, driver_count: 18, bus_count: 20, route_count: 12, admin_name: 'Hassan Al-Rashid', admin_email: 'hassan@alnoor.ae', created_at: '2024-09-01T08:00:00Z' },
  { id: 'sch_002', name: 'Sunrise Academy', address: '12 Knowledge Village', city: 'Abu Dhabi', state: 'Abu Dhabi', phone: '+971-2-555-0200', email: 'admin@sunrise.ae', plan_id: 'plan_standard', plan_name: 'Standard', status: 'active', subdomain: 'sunrise', student_count: 480, driver_count: 8, bus_count: 10, route_count: 6, admin_name: 'Fatima Al-Zahra', admin_email: 'fatima@sunrise.ae', created_at: '2024-10-15T08:00:00Z' },
  { id: 'sch_003', name: 'Green Valley School', address: '78 Education City', city: 'Sharjah', state: 'Sharjah', phone: '+971-6-555-0300', email: 'admin@greenvalley.ae', plan_id: 'plan_standard', plan_name: 'Standard', status: 'active', subdomain: 'greenvalley', student_count: 320, driver_count: 6, bus_count: 7, route_count: 4, admin_name: 'Mohammed Khalid', admin_email: 'mohammed@greenvalley.ae', created_at: '2025-01-10T08:00:00Z' },
  { id: 'sch_004', name: 'Bright Minds Institute', address: '33 Academic Boulevard', city: 'Ajman', state: 'Ajman', phone: '+971-6-555-0400', email: 'admin@brightminds.ae', plan_id: 'plan_basic', plan_name: 'Basic', status: 'active', subdomain: 'brightminds', student_count: 175, driver_count: 4, bus_count: 4, route_count: 3, admin_name: 'Aisha Rahman', admin_email: 'aisha@brightminds.ae', created_at: '2025-02-20T08:00:00Z' },
  { id: 'sch_005', name: 'Future Leaders School', address: '90 Industrial Area', city: 'Fujairah', state: 'Fujairah', phone: '+971-9-555-0500', email: 'admin@futureleaders.ae', plan_id: 'plan_basic', plan_name: 'Basic', status: 'suspended', subdomain: 'futureleaders', student_count: 140, driver_count: 3, bus_count: 3, route_count: 2, admin_name: 'Omar Abdullah', admin_email: 'omar@futureleaders.ae', created_at: '2025-03-05T08:00:00Z' },
  { id: 'sch_006', name: 'Star International Academy', address: '22 Academic Zone', city: 'Ras Al Khaimah', state: 'RAK', phone: '+971-7-555-0600', email: 'admin@starint.ae', plan_id: 'plan_premium', plan_name: 'Premium', status: 'active', subdomain: 'starint', student_count: 890, driver_count: 14, bus_count: 16, route_count: 9, admin_name: 'Noor Hussain', admin_email: 'noor@starint.ae', created_at: '2024-08-12T08:00:00Z' },
  { id: 'sch_007', name: 'Excellence School', address: '5 Knowledge Park', city: 'Dubai', state: 'Dubai', phone: '+971-4-555-0700', email: 'admin@excellence.ae', plan_id: 'plan_standard', plan_name: 'Standard', status: 'pending', subdomain: 'excellence', student_count: 0, driver_count: 0, bus_count: 0, route_count: 0, admin_name: 'Khalil Ahmad', admin_email: 'khalil@excellence.ae', created_at: '2026-06-20T08:00:00Z' },
  { id: 'sch_008', name: 'Pioneer Institute', address: '67 University Road', city: 'Abu Dhabi', state: 'Abu Dhabi', phone: '+971-2-555-0800', email: 'admin@pioneer.ae', plan_id: 'plan_premium', plan_name: 'Premium', status: 'active', subdomain: 'pioneer', student_count: 1050, driver_count: 16, bus_count: 18, route_count: 11, admin_name: 'Layla Hassan', admin_email: 'layla@pioneer.ae', created_at: '2024-07-01T08:00:00Z' },
]
