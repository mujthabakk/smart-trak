...
// Vite serves /public assets under the configured `base` path (e.g. '/smart-trak/'),
// so runtime string references must be prefixed with it explicitly.
...
export const APP_SCREENS: AppScreen[] = [
  { src: `${ASSET_BASE}app/login.png`, title: 'Secure Sign In', caption: 'School code, username & password — one login for parents, drivers and guests.' },
  { src: `${ASSET_BASE}app/attendance.png`, title: 'Live Attendance', caption: 'Track pickup and drop status for each child, day by day.' },
  { src: `${ASSET_BASE}app/alerts.png`, title: 'Real-time Alerts', caption: '“Boarded”, “Reached School” and trip updates the moment they happen.' },
  { src: `${ASSET_BASE}app/location.png`, title: 'Pickup & Drop Points', caption: 'Pin pickup and drop locations on the map for every student.' },
  { src: `${ASSET_BASE}app/message.png`, title: 'Compose Message', caption: 'Message drivers or admins with quick templates.' },
  { src: `${ASSET_BASE}app/fees.png`, title: 'Fee Details', caption: 'View due and paid transport payments at a glance.' },
]
...
export const FUNCTIONALITIES: FunctionalityTab[] = [
  {
    key: 'basic', label: 'Basic', screen: `${ASSET_BASE}app/login.png`,
    points: [
  ...
  {
    key: 'parent', label: 'Parent', screen: `${ASSET_BASE}app/alerts.png`,
    points: [
  ...
  {
    key: 'admin', label: 'Admin', screen: `${ASSET_BASE}app/location.png`,
    points: [
  ...
  {
    key: 'assistant', label: 'Assistant', screen: `${ASSET_BASE}app/attendance.png`,
    points: [
